...
class KahlanMatcherDriverTest extends TestCase
{
    protected function setUp()
    {
        $this->subject = new KahlanMatcherDriver();
    ...
    {
        $this->assertEquals(new KahlanMatcher($this->matcher), $this->subject->wrapMatcher($this->matcher));
    }
