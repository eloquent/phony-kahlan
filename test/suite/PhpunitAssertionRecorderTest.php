...
class KahlanAssertionRecorderTest extends TestCase
{
    protected function setUp()
    {
        $this->subject = new KahlanAssertionRecorder();
    ...
    public function testCreateFailure()
    {
        ...
        $this->expectException('Eloquent\Phony\Kahlan\KahlanAssertionException', $description);
